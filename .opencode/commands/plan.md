...
- /plan does not perform archival for `.opencode/plans`.
...
- Generate architecture-plan.md; archival is upstream only.
...
- Read @DESIGN.md.
- Generate extension-plan.md; archival is upstream only.
...
- Read @DESIGN.md.
- Generate refactor-plan.md; archival is upstream only.
